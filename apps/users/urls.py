...
from apps.users.views.reset_password.password_reset_custom_view import PasswordResetView
...
from apps.users.views.reset_password.password_reset_confirm_view import PasswordResetConfirmView
