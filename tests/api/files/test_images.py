...
class TestImage:
    def test_upload_image(self, simple_image_file, api_client, default_user_profile, user_data):
    ...
    def test_image_size_compression(self, compress_image_file, api_client, default_user_profile, user_data):
        login_user(api_client, user_data)
    ...
    def test_image_memory_size(self, big_image_file, api_client, default_user_profile, user_data):
        login_user(api_client, user_data)
    ...
    def test_image_format(self, wrong_ext_image_file, api_client, default_user_profile, user_data):
        login_user(api_client, user_data)
