...
def test_image_size_compression(image_file, api_client, default_user_profile, user_data):
    pass


def test_image_memory_size(image_file, api_client, default_user_profile, user_data):
    pass


def test_image_format(image_file, api_client, default_user_profile, user_data):
    pass
